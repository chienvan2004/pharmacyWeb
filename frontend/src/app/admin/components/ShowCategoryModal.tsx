            ...
            >
                <div className="flex items-start space-x-6">
                    ...
                    <div className="flex-grow">
                        <h2 className="text-2xl font-semibold text-gray-900 mb-3">{category?.category_name}</h2>

                        {category?.parent_category && (
                            <p className="text-gray-600 text-sm mb-2">
                                Thuộc danh mục cha: <span className="font-medium">{category.parent_category.category_name}</span>
                            </p>
                        )}
